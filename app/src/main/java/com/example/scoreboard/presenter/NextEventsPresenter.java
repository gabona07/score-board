...
public class NextEventsPresenter implements NextEventsContract.NextEventsPresenter {

    private static final String TAG = "NextEventsPresenter";
    private DataManager dataManager;
    private NextEventsContract.NextEventsView view;

    public NextEventsPresenter() {
    ...
    public void getNextEvents() {
        view.showLoading();
        Single<ResponseEvents> response = dataManager.getNextSportEventsResponse();
        ...
        response.subscribeOn(Schedulers.io())
                ...
                .subscribe(new SingleObserver<ResponseEvents>() {
                    ...
                    public void onSuccess(ResponseEvents value) {
                        ...
                        view.getNextEventsCallback(sportEvents);
                        view.hideLoading();
                    }
    ...
    public void onAttach(BaseContract.BaseView view) {
        this.view = (NextEventsContract.NextEventsView) view;
    }
